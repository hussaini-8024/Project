...
$badge_text = $sale_label ? $sale_label : __( 'Sale', 'giga-class-market' );
?>
<article class="gcm-course-card gcm-animate<?php echo $on_sale ? ' gcm-course-card--sale' : ''; ?>">
	<a class="gcm-course-card__media" href="<?php the_permalink(); ?>" aria-label="<?php echo esc_attr( get_the_title() ); ?>">
		...
		<?php endif; ?>
		<?php if ( $on_sale ) : ?>
			<span class="gcm-sale-badge"><?php echo esc_html( $badge_text ); ?></span>
		<?php endif; ?>
	</a>
	<div class="gcm-course-card__body">
		...
		<div class="gcm-course-card__footer">
			<?php if ( $on_sale ) : ?>
				<div class="gcm-price-block">
					<span class="gcm-price-block__sale"><?php echo esc_html( gcm_format_price( $sale_price ) ); ?></span>
