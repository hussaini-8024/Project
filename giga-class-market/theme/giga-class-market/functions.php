...
/**
 * Services page URL. Inquiry form lives here (not on /contact/).
 *
 * @param string $hash Optional fragment, default inquiry form.
 * @return string
 */
function gcm_services_url( $hash = 'inquiry' ) {
