<?php
/**
 * Single portfolio profile (public URL: /{slug}/ e.g. /navyan/).
 *
...
$portfolio_post = get_queried_object();
$profile        = class_exists( 'GCM_Portfolio_Service' ) ? GCM_Portfolio_Service::get_profile_from_post( $portfolio_post ) : array();
$projects       = class_exists( 'GCM_Portfolio_Service' ) ? GCM_Portfolio_Service::get_projects( $portfolio_post ? (int) $portfolio_post->ID : 0 ) : array();
...
if ( ! $photo_url && defined( 'GCM_THEME_URI' ) ) {
	$photo_url = trailingslashit( GCM_THEME_URI ) . 'assets/images/team/navyan-baig.jpg';
}
		...
		<div class="gcm-container">
			...
			<div class="gcm-folio-projects">
				<?php if ( empty( $projects ) ) : ?>
					<p class="gcm-folio-empty gcm-folio-reveal"><?php esc_html_e( 'Projects will appear here once added in Giga Class Market → Portfolio Projects.', 'giga-class-market' ); ?></p>
				<?php else : ?>
