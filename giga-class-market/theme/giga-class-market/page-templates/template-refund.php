	...
	<div class="gcm-container gcm-content">
		...
		while ( have_posts() ) :
			...
			if ( trim( get_the_content() ) ) {
				...
				<p><?php esc_html_e( 'Email or WhatsApp the support contacts listed on the Contact page with your full name, course name, and transaction ID.', 'giga-class-market' ); ?></p>
				<?php
			}
		endwhile;
		?>
