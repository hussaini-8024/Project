...
class GCM_Frontend {
	...
	public function contact_form_shortcode() {
		$url = function_exists( 'gcm_services_url' ) ? gcm_services_url() : home_url( '/services/#inquiry' );
		return '<p><a class="gcm-button gcm-button--gold" href="' . esc_url( $url ) . '">' . esc_html__( 'Send an inquiry on the Services page', 'giga-class-market' ) . '</a></p>';
	}
