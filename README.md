...
**GitHub user:** [faisal3537khan-max](https://github.com/faisal3537khan-max) · Muhammad Faisal Khan
...
Anyone opening this project can sign in to the dashboard with these values. They are also printed on the login screen.
