...
from aulabs.api import auth_routes, users_routes, storage_routes, sessions_routes, system_routes, agents_routes
...
api_router.include_router(agents_routes.router, prefix="/agents", tags=["agents"])
